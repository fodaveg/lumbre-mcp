...
export function createServer(config, opts = {}) {
    ...
    const { addTaskTool, listTasksTool, getTaskTool, completeTaskTool, cancelTaskTool, updateTaskTool, rescheduleTaskTool, deleteTaskTool, setSectionTool, removeSectionTool, addSubtaskTool, completeSubtaskTool } = registerTaskTools(server, ctx);
